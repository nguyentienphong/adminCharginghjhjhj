...
class Controller_Order_Detail_Manager extends Admin_Controller 
{
	...
	*/
	public function index()
	{
        ...
        //{
            ...
            $arrResult = $this->model_orders->get_partner_orders_detail_by_paging($limit_per_page, $start_index,$fromDate,$toDate, $orderStatus, $orderName, $targetAcc,$partner_username);
			 
			$params["results"] = $arrResult;
			$params["totalAmount"] = $this->calculateTotalAmount($arrResult);
            $config['base_url'] = base_url() . 'Controller_Order_Detail_Manager/index';
		...
		$this->render_template('order_detail_manager/index', $params);
